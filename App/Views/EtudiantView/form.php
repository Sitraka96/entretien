...
<?php } ?>
<article id="edit-student" class="overflow-hidden">
    <section class="row">
        <aside class="col-11 col-sm-11 col-md-10 col-lg-10 col-xl-10 mx-auto">
            <section id="main-header" class="d-flex flex-row flex-lg-row justify-content-between align-items-center">
                <a href="/Etudiant/Show/<?= $etudiant->nie ?>" class="btn-link">
                    <i class="bi bi-arrow-left mr-2"></i>
                    <span class="d-inline">Revenir</span>
                    <span class="d-none d-lg-inline">à son profil</span>
                </a>
            ...
            <section class="row">
                <aside class="col-12 col-lg-3 px-0 px-lg-3">
                    <nav id="scroll-menu-nav" class="navbar navbar-light bg-light position-fixed">
                        <nav class="nav nav-pills flex-row flex-lg-column w-100">
                            <h2 class="d-none d-lg-block">#<?= $etudiant->nie ?></h2>
                            <a class="nav-link" href="#about-student">Etudiant</a>
                            <a class="nav-link" href="#more-details">Parcours</a>
                ...
                <aside class="col-12 col-lg-9 px-0">
                    <div class="pb-5">
                        <form action="/Etudiant/Update/<?= $etudiant->nie ?>" method="post" id="etudiant-form" enctype="multipart/form-data">
                            <div id="accordionId" role="tablist" aria-multiselectable="false" class="py-5">
                                <div class="border-0">
                                    ...
                                    <article id="more-details">
                                        ...
                                        <article id="more-details-section" class="collapse show in pt-3" role="tabpanel" aria-labelledby="more-details-section-header">
                                                ...
                                                <aside class="col-12 col-lg-4 ml-auto">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" id="nie" class="form-control border-0 is-valid" value="<?= $nie ?>" disabled>
                                                        </div>
                                                    </div>
                                                </aside>
                                            </section>
                                            ...
                                            <section class="row">
                                                ...
                                                <aside class="col-12 col-lg-3 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="AU_id">Année universitaire</label>
                                                        <select data-submitter="Gp" name="AU_id" id="AU_id" class="form-control <?= array_key_exists("AU_id", $etudiant->invalidAttributes) ? 'is-invalid' : '' ?>" required>
                                                ...
                                                <aside class="col-12 col-lg-3 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select data-submitter="Gp:Document" name="NIV_id" id="NIV_id" class="form-control <?= array_key_exists("NIV_id", $etudiant->invalidAttributes) ? 'is-invalid' : '' ?>" required>
                                                ...
                                                <aside class="col-12 col-lg-3 col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="GP_id" id="GP_id" class="form-control <?= array_key_exists("GP_id", $etudiant->invalidAttributes) ? 'is-invalid' : '' ?>" required>
                                                ...
                                                <aside class="col-12 col-lg-5 col-xl-5">
                                                    <div class="form-group">
                                    ...
                                    <div id="required-documents" class="collapse show in pt-3" role="tabpanel" aria-labelledby="required-documents-header">
                                        ...
                                        <section id="required-documents-list" data-original-values="<?= $list_dossiers ?>" class="row m-0">
                                            <?php if (count($dossiers)) { ?>
                                                <?php foreach ($dossiers as $dossier) { ?>
                                                    <aside class="dossier-template col-12 col-lg-12 mb-3">
                                                        <fieldset class="border p-2">
                                                            <legend class="px-2"><?= $dossier->nom_dos ?></legend>
                                                            <div class="form-group form-check mx-2">
                                                                <input type="checkbox" name="list_dossiers[ids][]" id="dossier<?= $dossier->idDOS ?>" value="<?= $dossier->idDOS ?>" <?= (array_key_exists($dossier->idDOS, $list_dossiers) && $list_dossiers[$dossier->idDOS]["isValid"]) ? "checked" : "" ?> multiple="true" class="form-check-input">
                                                                <label for="dossier<?= $dossier->idDOS ?>" class="form-check-label">
                                                                </label>
                                                            </div>
                                                            <div class="form-group m-0">
                                                                <button class="btn btn-link add-observation-btn" type="button" data-toggle="collapse" data-target="#dossier<?= $dossier->idDOS ?>ObservationContainer" aria-expanded="<?= $list_dossiers[$dossier->idDOS]['observation'] != '' ? 'true' : 'false' ?>" aria-controls="dossier<?= $dossier->idDOS ?>ObservationContainer">
                                                                    Ajouter une observation
                                                                </button>
                                                                <div class="collapse <?= $list_dossiers[$dossier->idDOS]['observation'] != '' ? 'show' : '' ?>" id="dossier<?= $dossier->idDOS ?>ObservationContainer">
                                                                    <label for="dossier<?= $dossier->idDOS ?>Observation">Observation</label>
                                                                    <textarea name="list_dossiers[observation][<?= $dossier->idDOS ?>]" id="dossier<?= $dossier->idDOS ?>Observation" cols="30" rows="10" placeholder="Saisissez votre observation ici" class="form-control"><?= $list_dossiers[$dossier->idDOS]["observation"] ?></textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </aside>
